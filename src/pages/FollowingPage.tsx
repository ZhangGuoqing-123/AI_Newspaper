    ...
    <MobileLayout>
      ...
      <div className="px-4 pb-8">
        ...
        <motion.button
          ...
          className="w-full flex items-center gap-4 p-4 mb-6 rounded-2xl bg-gradient-to-r from-primary/10 via-accent/5 to-primary/10 border border-primary/20"
          whileTap={{ scale: 0.98 }}
