...
// 「关注」Tab 的内容（不含 MobileLayout / 页面标题，由 FeedPage 统一承载）
  ...
  return (
    <div className="px-4 pt-3 pb-8">
      <div className="flex items-baseline gap-2 mb-4">
        <span className="text-sm text-muted-foreground">已关注 {totalSourcesCount} 个信息源</span>
      </div>
      ...
      <div className="mb-6">
        ...
        {subscribedCollections.length === 0 ? (
          <div className="text-center py-8 bg-card rounded-xl">
            ...
            <p className="text-xs text-muted-foreground mt-1">切到发现页探索热门集合</p>
          </div>
        ) : (
